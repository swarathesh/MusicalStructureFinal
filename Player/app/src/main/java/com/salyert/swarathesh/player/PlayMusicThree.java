...
public class PlayMusicThree extends Activity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_play_music_three);
        ...
        switch (v.getId()) {
            ...
            case R.id.button:
                if (player != null ) {
                    player.stop();
                    player.release();
                    Intent intent = new Intent(PlayMusicThree.this,PlayMusic.class);
            ...
            case R.id.button3:
                if (player != null ) {
                    player.stop();
                    player.release();
                    Intent intent = new Intent(PlayMusicThree.this,PlayMusicTwo.class);
                    startActivity(intent);
